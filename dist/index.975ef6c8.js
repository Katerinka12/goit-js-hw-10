...
input.addEventListener("input", (0, _lodashDebounceDefault.default)((e)=>{
    const trimInput = input.value.trim();
    cleanHTML();
    if (trimInput !== " ") (0, _fetchCountries.fetchCountries)(trimInput).then((foundData)=>{
        if (foundData.length > 10) (0, _notiflixDefault.default).Notify.info("Too many matches found. Please enter a more specific name.");
        else if (foundData.length === 0) (0, _notiflixDefault.default).Notify.failure("Oops, there is no country with that name");
        else if (foundData.length >= 2 && foundData.length <= 10) renderCountryList(foundData);
        else if (foundData.length === 1) renderOneCountry(foundData);
    });
}, DEBOUNCE_DELAY));
...
},{"./css/styles.css":"1CY4s","./js/fetchCountries":"dKuy9","lodash.debounce":"3JP5n","notiflix":"5WWYd","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1CY4s":[function() {},{}],"dKuy9":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{}]},["1RB6v","8lqZg"], "8lqZg", "parcelRequireabb0")
